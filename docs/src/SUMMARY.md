...
- [Grammars](grammars-spec.md)
- [Security Considerations](security-spec.md)
...
- [Posture](extensions/posture.md)
- [Origins](extensions/origins.md)
- [Detection](extensions/detection.md)
...
- [Runtime Integration](guides/runtime-integration.md)
  - [Rust SDK](guides/sdks/rust.md)
  - [TypeScript SDK](guides/sdks/typescript.md)
  - [Python SDK](guides/sdks/python.md)
  - [Go SDK](guides/sdks/go.md)
  - [MCP Tools](guides/integrations/mcp.md)
  - [OpenAI Tool Calls](guides/integrations/openai.md)
  - [Anthropic Tool Use](guides/integrations/anthropic.md)
  - [LangChain and CrewAI](guides/integrations/langchain-crewai.md)
...
- [Errata Process](reference/errata.md)
- [JSON Schema](reference/json-schema.md)
- [Pattern Grammars](reference/patterns.md)
- [Error Reference](reference/errors.md)
- [Registries](reference/registries.md)
- [Normative Library](reference/specifications.md)
