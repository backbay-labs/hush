...
The full normative specification is at [`spec/hushspec-log.md`](https://github.com/backbay-labs/hush/blob/main/spec/hushspec-log.md); the entry schema is [`schemas/hushspec-log-entry.v0.schema.json`](https://github.com/backbay-labs/hush/blob/main/schemas/hushspec-log-entry.v0.schema.json).
