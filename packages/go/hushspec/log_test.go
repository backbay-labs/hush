...
// reproduces their entry hashes from the same inputs -- which is the
// byte-level cross-SDK check, the entry hash being the hash of the entry's
// canonical form.
