...
var canonicalSchemaSources = map[reflect.Type]struct{ file, def string }{
	reflect.TypeOf(HushSpec{}):                  {"hushspec-core.v1.schema.json", ""},
	reflect.TypeOf(Rules{}):                     {"hushspec-core.v1.schema.json", "Rules"},
	reflect.TypeOf(ForbiddenPathsRule{}):        {"hushspec-core.v1.schema.json", "ForbiddenPaths"},
	reflect.TypeOf(PathAllowlistRule{}):         {"hushspec-core.v1.schema.json", "PathAllowlist"},
	reflect.TypeOf(EgressRule{}):                {"hushspec-core.v1.schema.json", "Egress"},
	reflect.TypeOf(SecretPatternsRule{}):        {"hushspec-core.v1.schema.json", "SecretPatterns"},
	reflect.TypeOf(SecretPattern{}):             {"hushspec-core.v1.schema.json", "SecretPattern"},
	reflect.TypeOf(PatchIntegrityRule{}):        {"hushspec-core.v1.schema.json", "PatchIntegrity"},
	reflect.TypeOf(ShellCommandsRule{}):         {"hushspec-core.v1.schema.json", "ShellCommands"},
	reflect.TypeOf(ToolAccessRule{}):            {"hushspec-core.v1.schema.json", "ToolAccess"},
	reflect.TypeOf(ComputerUseRule{}):           {"hushspec-core.v1.schema.json", "ComputerUse"},
	reflect.TypeOf(RemoteDesktopChannelsRule{}): {"hushspec-core.v1.schema.json", "RemoteDesktopChannels"},
	reflect.TypeOf(InputInjectionRule{}):        {"hushspec-core.v1.schema.json", "InputInjection"},
	reflect.TypeOf(BrowserAutomationRule{}):     {"hushspec-core.v1.schema.json", "BrowserAutomation"},
	reflect.TypeOf(CodeExecutionRule{}):         {"hushspec-core.v1.schema.json", "CodeExecution"},
	reflect.TypeOf(Condition{}):                 {"hushspec-core.v1.schema.json", "Condition"},
	reflect.TypeOf(TimeWindowCondition{}):       {"hushspec-core.v1.schema.json", "TimeWindow"},
	reflect.TypeOf(RateCondition{}):             {"hushspec-core.v1.schema.json", "RateCondition"},
	reflect.TypeOf(Extensions{}):                {"hushspec-core.v1.schema.json", "Extensions"},
	reflect.TypeOf(GovernanceMetadata{}):        {"hushspec-core.v1.schema.json", "GovernanceMetadata"},
	reflect.TypeOf(ControlMapping{}):            {"hushspec-core.v1.schema.json", "ControlMapping"},

	reflect.TypeOf(PostureExtension{}):  {"hushspec-posture.v1.schema.json", ""},
	reflect.TypeOf(PostureState{}):      {"hushspec-posture.v1.schema.json", "PostureState"},
	reflect.TypeOf(PostureTransition{}): {"hushspec-posture.v1.schema.json", "PostureTransition"},

	reflect.TypeOf(OriginsExtension{}):        {"hushspec-origins.v1.schema.json", ""},
	reflect.TypeOf(OriginProfile{}):           {"hushspec-origins.v1.schema.json", "OriginProfile"},
	reflect.TypeOf(OriginMatch{}):             {"hushspec-origins.v1.schema.json", "OriginMatch"},
	reflect.TypeOf(OriginToolAccessOverlay{}): {"hushspec-origins.v1.schema.json", "ToolAccessRule"},
	reflect.TypeOf(OriginEgressOverlay{}):     {"hushspec-origins.v1.schema.json", "EgressRule"},
	reflect.TypeOf(OriginDataPolicy{}):        {"hushspec-origins.v1.schema.json", "DataPolicy"},
	reflect.TypeOf(OriginBudgets{}):           {"hushspec-origins.v1.schema.json", "OriginBudgets"},
	reflect.TypeOf(BridgePolicy{}):            {"hushspec-origins.v1.schema.json", "BridgePolicy"},
	reflect.TypeOf(BridgeTarget{}):            {"hushspec-origins.v1.schema.json", "BridgeTarget"},

	reflect.TypeOf(DetectionExtension{}):        {"hushspec-detection.v1.schema.json", ""},
	reflect.TypeOf(PromptInjectionDetection{}):  {"hushspec-detection.v1.schema.json", "PromptInjectionDetection"},
	reflect.TypeOf(PromptInjectionHeuristics{}): {"hushspec-detection.v1.schema.json", "PromptInjectionHeuristics"},
	reflect.TypeOf(JailbreakDetection{}):        {"hushspec-detection.v1.schema.json", "JailbreakDetection"},
	reflect.TypeOf(ThreatIntelDetection{}):      {"hushspec-detection.v1.schema.json", "ThreatIntelDetection"},
}
