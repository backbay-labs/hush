...
pub const SCHEMA_FILE_NAMES: &[(&str, &str)] = &[
    ...
    (
        "invocation-journal-experimental",
        "hushspec-invocation-journal-experimental.v1.schema.json",
    ),
...
"##,
  ...
  "$defs": {
    ...
    "artifact": {"type": "object", "additionalProperties": false, "required": ["path", "sha256", "bytes"], "properties": {
      "path": {"type": "string", "pattern": "^[A-Za-z0-9_-][A-Za-z0-9_.-]*(/[A-Za-z0-9_-][A-Za-z0-9_.-]*)*$", "maxLength": 4096},
